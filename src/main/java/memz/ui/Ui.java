...
public class Ui {
    ...
    public static final String PROPER_DEADLINE_FORMAT = "Correct format: deadline <description> /by <date(yyyy-mm-dd) or time>)";
    public static final String PROPER_EVENT_FORMAT = "Correct format: event <description> /from <date(yyyy-mm-dd) or time> /to <date(yyyy-mm-dd) or time>";
